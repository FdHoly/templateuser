                            ...
                            <div class="post-thumb-gallery img-gallery">
                                <div class="row no-gutters">
                                    <div class="col-6">
                                        <figure class="post-thumb">
                                            <a class="gallery-selector"
                                                href="{{ url('assets/images/post/post-large-6.jpg') }}">
                                    ...
                                    <div class="col-6">
                                        <figure class="post-thumb">
                                            <a class="gallery-selector"
                                                href="{{ url('assets/images/post/post-large-7.jpg') }}">
                    ...
                    <div class="card">
                        ...
                        <div class="post-title d-flex align-items-center">
                            ...
                            <div class="profile-thumb">
                                <a href="#">
                                    <figure class="profile-thumb-middle">
                                        <img src="{{ url('assets/images/profile/profile-small-6.jpg') }}"
                                            alt="profile picture">
                                    </figure>
                                </a>
                            </div>
                                ...
                                <ul class="like-page-list-wrapper">
                                    ...
                                    <li class="unorder-list">
                                        ...
                                        <div class="profile-thumb">
                                            <a href="#">
                                                <figure class="profile-thumb-small">
                                                    <img src="{{ url('assets/images/profile/profile-small-35.jpg') }}"
                                                        alt="profile picture">
                                                </figure>
                                            </a>
                                        </div>
                                    ...
                                    <li class="unorder-list">
                                        ...
                                        <div class="profile-thumb">
                                            <a href="#">
                                                <figure class="profile-thumb-small">
                                                    <img src="{{ url('assets/images/profile/profile-small-15.jpg') }}"
                                                        alt="profile picture">
                                                </figure>
                                            </a>
                                        </div>
                                    ...
                                    <li class="unorder-list">
                                        ...
                                        <div class="profile-thumb">
                                            <a href="#">
                                                <figure class="profile-thumb-small">
                                                    <img src="{{ url('assets/images/profile/profile-small-34.jpg') }}"
                                                        alt="profile picture">
                                                </figure>
                                            </a>
                                        </div>
